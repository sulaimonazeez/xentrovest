      ...
      >
        ...
        <div className="glass" style={{ padding: "2.5rem" }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {error && (
              <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} style={{ background: "rgba(255,77,109,0.12)", border: "1px solid rgba(255,77,109,0.3)", borderRadius: 10, padding: "0.75rem 1rem", fontSize: "0.85rem", color: "#FF4D6D", marginBottom: "1.25rem" }}>
                <i className="bi bi-exclamation-circle me-2"></i>{error}
              </motion.div>
            )}

            <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} type="submit" className="btn-gold" style={{ width: "100%", padding: "1rem", fontSize: "0.95rem" }} disabled={loading}>
              {loading ? <><span style={{ width: 16, height: 16, border: "2px solid rgba(0,0,0,0.3)", borderTop: "2px solid #000", borderRadius: "50%", display: "inline-block", animation: "spin 0.8s linear infinite", marginRight: 8, verticalAlign: "middle" }}></span>Signing in...</> : "Sign In"}
            </motion.button>
          </form>

          <p style={{ textAlign: "center", marginTop: "1.5rem", fontSize: "0.85rem", color: "var(--muted)", margin: "1.5rem 0 0" }}>
